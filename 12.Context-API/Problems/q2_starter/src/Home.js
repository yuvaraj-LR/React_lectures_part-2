  ...
  return (
    <div>
      <div className="language-container">
        ...
        <span onClick={() => language.setLanguage("English")}>English</span>
        <span onClick={() => language.setLanguage("Hindi")}>Hindi</span>
        <span onClick={() => language.setLanguage("Marathi")}>Marathi</span>
      </div>
      <p>
        {/* Show active language content here */}
